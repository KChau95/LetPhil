...
const getStringLength = (str) => {return str.length}
console.log(getStringLength("Kevin"));

const greetPerson = (name) => {return `Hello, ${name}`}
console.log(greetPerson("Alex"));

console.log(squareNumber(10));

console.log("It does not matter how slowly you go as long as you do not stop.")
